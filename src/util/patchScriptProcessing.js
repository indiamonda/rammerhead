...
const FALLBACK = [
    ...
    '__get$GwUrl=function(u,d){return u},',
...
const IFRAME_PROXY = [
    ...
    'function getCtx(){',
      ...
      'try{var h=getHH();if(h&&h.settings&&h.settings._settings){',
        ...
        '_sid=s.sessionId;',
        '_pOrig=s.forceGwSrcForImage?null:(location.protocol+"//"+location.host)}}catch(e){}',
    ...
    'function proxyUrl(url){',
      'var h=getHH();',
      'if(h&&h.utils&&h.utils.url&&h.utils.url.getGwUrl){',
        'try{return h.utils.url.getGwUrl(url,{resourceType:"i"})}catch(e){}}',
